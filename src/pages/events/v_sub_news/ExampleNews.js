...
class NewsPage extends React.Component {
    ...
    render() {
        ...
        return (
            <>
            <Helmet>
                <title>New Building at This Year 2021 Will Usefull for Practicing Milenial</title>
            </Helmet>
                <div className="headerCustom mt-2">
                    <div className="overlay"></div>
                    <img src="/assets/img/new_building.jpg" className="customImg align-self-center d-none d-lg-block" alt="" />
                        ...
                        <div style={{ paddingLeft: '20vh' }}>
                            <MDBRow>
                                <MDBCol md='12' className='mt-4'>
                                    <p className="titleContent">New Building at This Year 2021 Will Usefull for Practicing Milenial</p>
